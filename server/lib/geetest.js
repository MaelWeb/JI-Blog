...
class GeeTest {
    ...
    register(data) {
        data = data || {};
        return SuperAgent.get(defaultConfig.PROTOCOL + defaultConfig.API_SERVER + defaultConfig.REGISTER_PATH)
            .query({
                gt: this.geetest_id,
            ...
            .then(res => {
                ...
                if (res.status != 200 || !resData.challenge) {
                    let challenge = this._make_challenge();
                    return {
                        code: 201,
                        data: {
                            gt: this.geetest_id,
                    ...
                    let challenge = md5(resData.challenge + this.geetest_key);
                    return {
                        code: 200,
                        data: {
                            gt: this.geetest_id,
