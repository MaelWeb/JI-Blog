...
class Toast {
    ...
    info(options) {
        let _options =      typeof options === 'object'
          ? Object.assign({}, this.defaulOpts, options)
        : this.defaulOpts;
    ...
    creat(options) {
        ...
        const length = this.toasts.push(document.getElementById(options.id));

        const dom = this.toasts[length - 1];
