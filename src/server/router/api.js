...
import {
    ...
    hideArticle,
    getTopArticles
} from '../controllers/article_ctr';
import {
    getOneContent,
    pushToBaidu,
    geeTestRegister
} from '../controllers/common_ctr';
...
import {
    ...
    showAndHideComent,
    deleteComment
} from '../controllers/comment_ctr';
import {
    createBanner,
    getBanners,
    updateBanner,
    deleteBanner
} from '../controllers/banner_ctr';
import {
    createBook,
    getBooks,
    updateBook,
    deleteBook
} from '../controllers/book_ctr';

const Router = new router();

const _Api = Router.get('/signout', ctx => {
  ctx.session = null;
  ctx.body = {
    code: 200,
    message: "登出成功"
