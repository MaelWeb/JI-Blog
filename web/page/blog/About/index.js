    ...
    render() {
        return (
            <div className="blog-about">
                <img src="http://cdn.liayal.com/image/about_banner2.jpg" alt="about me"/>
                ...
                <div className="about-module">
                    <img src="http://cdn.liayal.com/image/book.jpg" alt=""/>
                ...
                <div className="about-module">
                    ...
                    <img src="http://cdn.liayal.com/image/tour.jpg" alt=""/>
                </div>
                <div className="about-module">
                    <img src="http://cdn.liayal.com/image/basketball.jpg" alt=""/>
                    <div className="moule-txt pdl">
                        <h2>运动</h2>
                ...
                <div className="about-module">
                    ...
                    <img src="http://cdn.liayal.com/image/tv.jpg" alt=""/>
                </div>
            </div>
        )
    }
